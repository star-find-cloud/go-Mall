...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "handler.MerchantRegisterRequest": {
            ...
            "properties": {
                "businessType": {
                    "description": "BusinessType represents the categories of business the merchant operates in\nRequired: true\nExample: [1, 3, 5]",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
                ...
                "email": {
                    "description": "Email is the merchant's contact email address\nRequired: true\nExample: merchant@example.com",
                    "type": "string"
                },
                "name": {
                    "description": "Name is the merchant's business name\nRequired: true\nMin length: 2\nMax length: 32",
                    "type": "string",
                    "maxLength": 32,
                    "minLength": 2
                },
                ...
                "phone": {
                    "description": "Phone is the merchant's contact phone number in E.164 format\nRequired: true\nExample: +8613800138000",
                    "type": "string"
                },
                "realID": {
                    "description": "RealID is the ID card number of the merchant's representative\nRequired: true\nLength: 18",
                    "type": "string",
                    "maxLength": 18,
                    "minLength": 18
                },
                "realName": {
                    "description": "RealName is the legal name of the merchant's representative\nRequired: true\nMin length: 2\nMax length: 32",
                    "type": "string",
                    "maxLength": 32,
                    "minLength": 2
                },
        ...
        "handler.UpdateRequest": {
            ...
            "properties": {
                ...
                "sex": {
                    "description": "@Description 性别(203:未知 201:男 202:女)\n@Required false\n@Enum 201 202 203\n@Example 1",
                    "type": "integer",
                    "enum": [
                        0,
                        1,
